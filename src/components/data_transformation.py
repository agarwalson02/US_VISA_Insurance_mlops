...
from src.utils.main_utils import read_yaml_file,drop_columns,save_object,save_numpy_array_data
from src.entity.estimator import TargetValueMapping

class DataTransformation:
    def __init__(self,data_ingestion_artifcat:DataIngestionArtifact,
    ...
    def initiate_data_transformation(self,)->DataTransformationArtifact:
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Got the transformer object")
